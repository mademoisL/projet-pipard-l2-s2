...
//Appel de fonction retournant un tableau
...
<head>
    <meta charset="UTF-8">
    <title>SMARTPARK – Parking en temps réel</title>
    ...
    <style>
        ...
        .place-card { text-align:center; padding:20px; border-radius:10px; border:2px solid transparent; transition:0.3s; }
        ...
        .statut-label    { display:block; font-size:0.8rem; margin-top:10px; text-transform:uppercase; font-weight:bold; }
    </style>
</head>
<body>
...
<main style="padding-top:120px; max-width:1000px; margin:0 auto;">
    ...
    <?php if (isset($_GET['success'])): ?>
        <p style="color:#00ffcc; text-align:center;">Réservation confirmée !</p>
    <?php endif; ?>

    <?php if (isset($_GET['erreur']) && $_GET['erreur'] === 'indisponible'): ?>
        <p style="color:#ff4d4d; text-align:center;">Cette place n'est plus disponible.</p>
    <?php endif; ?>
    ...
    <div class="parking-grid">
        <?php
        //foreach sur le tableau $places
        foreach ($places as $place):
            //Appel de fonction getStatutClasse()
            $classe = getStatutClasse($place['statut']);
        ?>
            <div class="place-card <?= $classe ?> card">
